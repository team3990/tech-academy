...
class CoursesController extends \BaseController { 
	...
	public function index($id = NULL)
	{
		...
		if ($id === NULL)
		{
		    ...
		    {
		    	$courses = \T4KModels\Course::where('is_private', false)->get();
		    }
		}
		else
		{
		    // Retrieve all courses by subject
		    $selected_subject = \T4KModels\Subject::find($id);
		}
	    ...
	    $data = array(
                ...
                'ItemsCount'        => (isset($courses)) ? count($courses) : count($selected_subject->courses),
